...
本書は [business-requirements.md](business-requirements.md) のユースケース概要・ステークホルダーを反映した **ビジネスレベル** のユースケース図である。実装クラスや API 名は含めない。
...
- 各 UC の **シーケンス図（時系列）**: [sequence-diagrams.md](sequence-diagrams.md)
