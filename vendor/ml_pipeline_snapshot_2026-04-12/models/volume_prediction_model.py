"""
Volume Prediction Model (Regression)
将来の取引量を予測する回帰モデル
"""
import os
import joblib
...
class VolumePredictionModel:
    """
    取引量予測用の回帰モデル
    XGBoost Regressorを使用して将来の取引量を予測
    """
    ...
    @classmethod
    def load(cls, filepath: str) -> 'VolumePredictionModel':
        """
        モデルをファイルからロード
        ...
        Returns:
            ロードされたVolumePredictionModelインスタンス
        """
